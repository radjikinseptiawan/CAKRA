...
interface CameraContextHooks {
  ...
  count: { private: number; public: number };
  setCount: Dispatch<SetStateAction<{ private: number; public: number }>>;
}
...
export const CameraProvider = ({ children }: { children: ReactNode }) => {
  ...
  const [count, setCount] = useState<{ private: number; public: number }>({
    private: 0,
    public: 0,
  });
  return (
